...
most cost efficent campaigns.
identify points and places with over spending.
campaigns revenue

KPIs calculated:
Click through rate for engagement, Cost per click for cost efficency, and Return on Ad Spend for profitability

and the better campaign was identified

3) analyzing the company monthly and yearly performance
